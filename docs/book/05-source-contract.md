...
- A legacy `% !LOOM basis: definition` directive is read as `expository` and reported with that migration in `basis_reason`; newly written directives use `expository` (DR-213).
