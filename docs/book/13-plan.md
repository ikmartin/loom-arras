...
2. `loom atomize drafting/draft3.tex drafting/draft4.tex --sections`; `draft3.tex` deleted; `main` updated; identity test. Performed at M7: 52 nodes and 3 deferred proofs moved, a 104-line spine, identity passing, `inline --all` passing it again, `loom check` ok (`M7.md`, criterion 3).
