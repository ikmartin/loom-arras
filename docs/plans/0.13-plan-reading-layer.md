...
![The split view](../long-prompts/images/split-view.png)
...
![The side panel](../long-prompts/images/side-panel.png) · ![The session selector](../long-prompts/images/session-selector-b-c.png) · ![Deleting a session](../long-prompts/images/delete-session.png)
...
![Floating box](../long-prompts/images/placement-floating.png) · ![Margin column](../long-prompts/images/placement-margin.png) · ![Inline](../long-prompts/images/placement-inline.png)
...
**Figures** — the split view, the side panel, the session selector, the delete confirmation, the three placements, and the proposal box's new arrangement, all as screenshots in `docs/long-prompts/images/` with their text cartoons beside them, so the report survives a moved image.
