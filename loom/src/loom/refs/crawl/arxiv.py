"""arXiv: primary categories, and where a work's source is (book 8.13.2).

Categories come from the export API, several identifiers to a request; arXiv asks for one request every three seconds on a single connection, which the service spacing gives.
"""
